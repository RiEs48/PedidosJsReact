...
export const ModalProducto = () => {
    ...
    // USEEFFECT siempre es un callback pasamos como dependencia el pedido de Use Quiosco
    useEffect(()=>{
  ...
  return (
    <div className="md:flex gap-10">
            ...
            <div className="md:w-2/3">
                ...
                <button
                type="button"
                className="bg-green-600 hover:bg-green-900 px-5 py-2 mt-5 text-white font-bold uppercase rounded"
                onClick={()=> {
